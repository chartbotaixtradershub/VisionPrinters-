...
window.addEventListener("load", () => { const params = new URLSearchParams(window.location.search); token = params.get("token") ? decodeURIComponent(params.get("token")) : null; const account = params.get("acct") || "-"; const currency = params.get("cur") || "-";
